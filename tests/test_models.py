...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_product_successfully(self):
        """It should update a product successfully when it has an ID"""
        product = ProductFactory()
        product.id = None
        product.create()
    ...
    def test_find_by_price_with_decimal(self):
        """It should find products by price using a Decimal value"""
        products = ProductFactory.create_batch(5)
        for product in products:
            product.create()
    ...
    def test_find_by_price_with_string(self):
        """It should find products by price using a string value"""
        products = ProductFactory.create_batch(5)
        for product in products:
            product.create()
        ...
        found = Product.find_by_price(f' "{target_price}" ')
